...
class Experiment:
    ...
    def _unpack_batch(self, batch: SubgraphFeaturesBatch) -> tuple[SubgraphFeaturesBatch, torch.Tensor]:
        ...
        if self.cfg.model_config.subgraph_sampling:
            ...
            if self.cfg.model_name in ('SD-GNN', 'ARCH-2', 'ARCH-2-V2', 'ARCH-3', 'ARCH-4', 'ARCH-5', 'ARCH-6', 'ARCH-7', 'ARCH-7-V2', 'ARCH-7-V3', 'ARCH-7-V4', 'ARCH-7-V5', 'ARCH-8-A', 'ARCH-8-B', 'ARCH-9', 'ARCH-10', 'ARCH-11', 'ARCH-14', 'ARCH-15', 'ARCH-16', 'ARCH-18'):
